# Migrate VMware VMs to Alibaba Cloud

This topic describes how to migrate VMware virtual machines \(VMs\) to Alibaba Cloud. After the migration, VMware Tools is no longer required by the Elastic Compute Service \(ECS\) instances in Alibaba Cloud.
...
-   [Prepare for the migration of a Windows-based VMware VM to Alibaba Cloud](#section_uub_t57_m6r)
-   [Prepare for the migration of a Linux-based VMWare VM to Alibaba Cloud](#section_emy_9bz_gwd)

After the preparations are complete, you can start the migration. For more information, see [Migrate VMware VMs to Alibaba Cloud](#section_bin_x1v_n67). If you migrate a VM for the first time, we recommend that you perform a test migration.

## Prepare for the migration of a Windows-based VMware VM to Alibaba Cloud
...
## Prepare for the migration of a Linux-based VMWare VM to Alibaba Cloud
