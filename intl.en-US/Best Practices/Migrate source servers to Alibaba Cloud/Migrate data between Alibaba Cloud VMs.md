...
You can use this migration method to decrease the disk size of an Elastic Compute Service \(ECS\) instance. For more information, see [Decrease the size of a disk](/intl.en-US/Best Practices/Block Storage/Shrink disk.md).
...
You can use this migration method to migrate data between Linux-based Alibaba Cloud VMs across accounts, regions, or VPCs.
