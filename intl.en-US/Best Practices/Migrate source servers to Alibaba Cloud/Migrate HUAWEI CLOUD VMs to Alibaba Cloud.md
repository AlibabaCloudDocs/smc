# Migrate HUAWEI CLOUD VMs to Alibaba Cloud

This topic describes how to migrate HUAWEI CLOUD virtual machines \(VMs\) to Alibaba Cloud.
...
-   [Prepare for the migration of a Windows-based HUAWEI CLOUD VM to Alibaba Cloud](#section_jg5_rha_uof)
-   [Prepare for the migration of a Linux HUAWEI CLOUD VM to Alibaba Cloud](#section_jyy_9ds_g7f)

After the preparations are complete, you can start the migration. For more information, see [Migrate HUAWEI CLOUD VMs to Alibaba Cloud](#section_5al_6d6_f0e). If you migrate a VM for the first time, we recommend that you perform a test migration.

## Prepare for the migration of a Windows-based HUAWEI CLOUD VM to Alibaba Cloud
...
-   Check whether the QEMU Guest Agent VSS Provider service is installed.
...
## Prepare for the migration of a Linux HUAWEI CLOUD VM to Alibaba Cloud
...
-   Make sure that rsync is installed. For more information, see [How do I install Rsync?](/intl.en-US/FAQ/SMC FAQ.md)
-   Check the validity of your application licenses. After you migrate the VMWare VM to Alibaba Cloud, the application licenses that are associated with the underlying hardware may become invalid.
