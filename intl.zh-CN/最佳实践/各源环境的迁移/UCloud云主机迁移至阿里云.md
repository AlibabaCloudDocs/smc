...
答：某些Linux系统内核由UCloud云平台定制，可能与阿里云平台不兼容。您可以更换Linux系统内核，例如，对于CentOS操作系统，您可以更换[CentOS官方内核](http://vault.centos.org/)。您也可以寻求技术支持，请参见[联系我们](/intl.zh-CN/常见问题/联系我们.md)。
