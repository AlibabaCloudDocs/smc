...
迁移任务将自动周期性执行，并同步增量数据至阿里云。增量迁移的最佳实践，请参见[增量迁移源服务器](/intl.zh-CN/最佳实践/增量迁移源服务器.md)。
            ...
            -   选择**云服务器实例**。配置项说明如下：
                ...
                **说明：** 迁移源和目标实例的存储、操作系统等需要适配。迁移至目标实例最佳实践，请参见[源服务器迁移至目标实例]()。

                ![smc-instance](https://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/zh-CN/1170973061/p176925.png)
