...
您可以参见本文档中的步骤，将UCloud云主机迁移至阿里云。

在开始迁移服务器之前，您需要针对不同系统的虚拟机进行准备工作。详情请参见：

-   [UCloud Windows系统迁移至阿里云](#section_tw7_piv_82n)
-   [UCloud Linux系统迁移至阿里云](#section_4jv_ynd_fqm)

准备工作完成后，即可开始正式的迁移操作。详情请参见[迁移虚拟机至阿里云](#section_z1r_s12_f2i)。如果您是第一次进行服务器迁移，建议先使用测试机演练。

## UCloud Windows系统迁移至阿里云
...
答：某些Linux系统内核由UCloud云平台定制，可能与阿里云平台不兼容。您可以更换Linux系统内核，例如，对于CentOS操作系统，您可以更换[CentOS官方内核](http://vault.centos.org/)。您也可以寻求技术支持，请参见[联系我们](/cn.zh-CN/常见问题/联系我们.md)。
