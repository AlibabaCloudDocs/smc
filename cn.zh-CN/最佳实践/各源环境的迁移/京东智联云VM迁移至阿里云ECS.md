...
您可以参见本文档中的步骤，将京东智联云VM实例迁移至阿里云。

在开始迁移服务器之前，您需要针对不同系统的虚拟机进行准备工作。详情请参见：

-   [京东智联云VM Windows系统迁移至阿里云](#section_5sk_g64_tvk)
-   [京东智联云VM Linux系统迁移至阿里云](#section_l27_jkc_8l4)

准备工作完成后，即可开始正式的迁移操作。详情请参见[迁移虚拟机至阿里云](#section_xsr_4p7_5q2)。如果您是第一次进行服务器迁移，建议先使用测试机演练。

## 京东智联云VM Windows系统迁移至阿里云
