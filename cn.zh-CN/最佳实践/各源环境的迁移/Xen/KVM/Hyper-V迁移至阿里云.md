# Xen/KVM/Hyper-V迁移至阿里云

您可以参见本文档中的步骤，将Xen/KVM/Hyper-V虚拟机迁移至阿里云。

在开始迁移服务器之前，您需要针对不同系统的虚拟机进行准备工作。详情请参见：

-   [Windows系统迁移至阿里云](#section_0hb_wwn_fan)
-   [Linux系统迁移至阿里云](#section_atn_c1d_4l6)

准备工作完成后，即可开始正式的迁移操作。详情请参见[迁移虚拟机至阿里云](#section_5qh_h2l_mhk)。如果您是第一次进行服务器迁移，建议先使用测试机演练。
