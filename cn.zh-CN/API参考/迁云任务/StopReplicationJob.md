...
前往【[API Explorer](https://api.aliyun.com/#product=smc&api=StopReplicationJob)】在线调试，API Explorer 提供在线调用 API、动态生成 SDK Example 代码和快速检索接口等能力，能显著降低使用云 API 的难度，强烈推荐使用。
